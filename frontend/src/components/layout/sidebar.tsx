...
export default function Sidebar() {
  ...
  return (
    <div
      ...
      } min-h-screen border-r border-neutral-200 dark:border-neutral-800 hidden sm:block relative transition-all duration-300 ease-in-out`}
    >
      <div className="px-5 py-6 flex items-center justify-between">
        <Link
          href="/"
          className="group flex items-center gap-2 text-sm font-semibold text-neutral-900 dark:text-neutral-100 transition-all duration-200 hover:text-blue-600 dark:hover:text-blue-400 hover:scale-105 cursor-pointer"
        >

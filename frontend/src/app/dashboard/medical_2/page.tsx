// This file is a near-duplicate of the medical page, but for 'medical_2'.
// It uses the 'medical_2_quality_detailed_scores.csv' and the 'medical_quality_score_2' column from scored_final_dataset.csv.
...
export default function Medical2AnalysisPage() {
  ...
  const fiveAxisRadar = useMemo(() => {
    ...
    try {
      ...
      return {
        ...
        datasets: [
          {
            label: "Medical 2 Quality Dimensions",
  ...
  const stackedBarData = useMemo(() => {
    ...
    try {
      ...
      const colors = [
        "#3B82F6", "#6B7280", "#14B8A6", "#9CA3AF", "#D1D5DB"
      ];
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-neutral-800 rounded-xl border border-gray-200 dark:border-neutral-700 p-6">
        <h1 className="text-base md:text-2xl font-semibold text-gray-900 dark:text-white mb-2">Medical 2 Quality Analysis</h1>
          ...
          {!(
            ...
            <>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {chartData.barData && (
                  <ChartContainer title="Average Medical 2 Quality Dimensions">
                ...
                {chartData.radarData && (
                  <ChartContainer title="Average Medical 2 Quality Radar">
              ...
              <div className="bg-white dark:bg-neutral-800 rounded-xl border border-gray-200 dark:border-neutral-700 p-6">
                <h3 className="text-xs md:text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">Overall Medical 2 Quality Score</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {horizontalBarData && (
          <ChartContainer title="Medical 2 Quality Score by Question">
        ...
        {fiveAxisRadar && (
          <ChartContainer title="Five Medical 2 Quality Dimensions">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {stackedBarData && (
          <ChartContainer title="Axis Contribution to Medical 2 Quality">
        ...
        {trendLineData && (
          <ChartContainer title="Medical 2 Quality Score Progression">

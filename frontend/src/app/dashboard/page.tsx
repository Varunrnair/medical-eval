    ...
    <div className="space-y-6 min-h-screen">
      <div className="bg-white dark:bg-neutral-800 rounded-lg border border-gray-200 dark:border-neutral-700 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="bg-white dark:bg-neutral-800 p-3 rounded-md border border-gray-200 dark:border-neutral-700">
        ...
        {medicalDistribution && (
          <ChartContainer title="Medical Quality Score Distribution">
            ...
            <div className="w-full flex flex-col items-center">
              <div className="max-w-md w-full h-60 mx-auto bg-white dark:bg-neutral-800 rounded-lg">
